...
![vLLM](https://img.shields.io/badge/vLLM-667EEA?style=for-the-badge&logo=openai&logoColor=white)
...
|---------|-------------|------|
| [nano-vllm](https://github.com/Beater-221E/nano-vllm) | Nano vLLM for learning | `Python` |
| [MinivLLM](https://github.com/Beater-221E/MinivLLM) | Mini vLLM for learning | — |
| [Triton-Tutorial](https://github.com/Beater-221E/Triton-Tutorial) | GPU kernel learning notes | `Python` |

### 📚 Study Notes

| Project | Description | Lang |
|---------|-------------|------|
| [PyTorch-SourceCode-Overview](https://github.com/Beater-221E/PyTorch-SourceCode-Overview) ⭐ | PyTorch source code walkthrough | — |
| [RL-paper-step-by-step](https://github.com/Beater-221E/RL-paper-step-by-step) | Reinforcement learning paper breakdowns | — |
...
| Project | Description | Lang |
|---------|-------------|------|
| [Digital-twin_SURF2023](https://github.com/Beater-221E/Digital-twin_SURF2023) | SURF2023 digital twin · Webots dev reference | `Python` |
| [webots](https://github.com/Beater-221E/webots) | Webots Robot Simulator *(fork)* | `C++` |
